...
class MonoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # frame_index = torch.from_numpy(np.array(int(folder[-8:-5])))
        # side = "l"
        ...
        for i in self.frame_idxs:
            if i == "s":
                ...
                inputs[("color", i, -1)], inputs[("color_r", i, -1)] = self.get_color(folder, frame_index + i, side, do_flip)
